...
namespace DiarioOficial.CrossCutting.Errors.Person
{
    ...
    public record PersonNotSaved()
        : BaseError("Não foi possível salvar o nome atual. Verifique os dados fornecidos.", nameof(PersonNotSaved), StatusCodes.Status400BadRequest);
